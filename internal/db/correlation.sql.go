...
session_live AS (
    SELECT tenant, project_id, external_ref, branch, sha, harness, session_id, sess_events, sess_first, sess_last, sess_terminal_status, sess_title, sess_kind, sess_cost,
        CASE
